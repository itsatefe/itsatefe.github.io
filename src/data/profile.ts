...
export const skills = {
  ...
  cloud: ["Google Cloud Platform", "Vertex AI", "Cloud Run", "Cloud Scheduler", "Docker"],
  ai: ["LLM Integration", "Natural Language Processing", "Deep Learning", "Feature Engineering"],
